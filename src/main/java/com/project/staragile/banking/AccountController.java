...
public class AccountController {
    ...
    public Account updatePolicy(@PathVariable int accountNumber, @RequestBody Account updatedPolicy) {
        return accountService.updateAccount(accountNumber,updatedPolicy);
    }
	
	@DeleteMapping("/deletePolicy/{accountNumber}")
    public String deletePolicy(@PathVariable int accountNumber) {
        return accountService.deleteById(accountNumber);
    }
